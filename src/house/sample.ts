...
export const SAMPLE_HOUSE: HouseConfig = {
  ...
  entities: {
    ...
    movieList: 'todo.movie_night',
    skyList: 'todo.night_sky',
    ...
    outdoorWind: 'sensor.outdoor_wind',
    outdoorRainToday: 'sensor.rain_today',
    outdoorUv: 'sensor.uv_index',
    wateringVerdict: 'sensor.watering_verdict',
    raining: 'binary_sensor.is_raining',
    rachioSchedule: 'switch.lawn_schedule',
    rachioZones: [
      ['Front Yard', 'switch.sprinkler_zone_1'],
      ['Back Yard', 'switch.sprinkler_zone_2'],
    ] as const,
    sonos: [
